...
const FeaturesContainer = ({
	...
	const handleDeleteMethod = useCallback(position => handleDelete(position, setFeatures), []);

	const handleSelectionMethod = useCallback(option => handleSelection(option, setFeatures, features), [features]);

	const handleLabelChangeMethod = useCallback(
		(position, value) => handleLabelChange(position, value, setFeatures), []
	);
